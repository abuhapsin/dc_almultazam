...
<html>
    <head>
        ...
        <!-- Plugins css-->
        <link href="<?php echo base_url('assets/assets/tagsinput/jquery.tagsinput.cs');?>" rel="stylesheet" />
        <link href="<?php echo base_url('assets/assets/toggles/toggles.css" rel="stylesheet');?>" />
        ...
        <link href="<?php echo base_url('assets/assets/colorpicker/colorpicker.css');?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('assets/assets/jquery-multi-select/multi-select.css');?>"  rel="stylesheet" type="text/css" />
    ...
    <body class="fixed-left">
        ...
        <script src="<?php echo base_url('assets/assets/tagsinput/jquery.tagsinput.min.js');?>"></script>
        <script src="<?php echo base_url('assets/assets/toggles/toggles.min.js');?>"></script>
        <script src="<?php echo base_url('assets/assets/timepicker/bootstrap-timepicker.min.js');?>"></script>
        <script src="<?php echo base_url('assets/assets/timepicker/bootstrap-datepicker.js');?>"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/assets/colorpicker/bootstrap-colorpicker.js');?>"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/assets/jquery-multi-select/jquery.multi-select.js');?>"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/assets/jquery-multi-select/jquery.quicksearch.js');?>"></script>
        <script src="<?php echo base_url('assets/assets/bootstrap-inputmask/bootstrap-inputmask.min.js');?>" type="text/javascript"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/assets/spinner/spinner.min.js');?>"></script>
